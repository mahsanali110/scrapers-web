...
class KillTranscribe:
    ...
    def create_log(self, day, year, month):
        try:
            ...
            logging.info('%s - %s', 'EXCEPTION IN CREATING LOG FILE', e)
            ...
            try:
                ...
                if file_count2 == file_count1:
                    ...
                    if len(output) != 0:
                        ...
                        logging.info("%s", "KILLED PROCESSES OF WEB")
                        time.sleep(180)
            except Exception as e:
                logging.info('%s - %s', 'EXCEPTION IN MAIN FUNCTION', e)
                if e.strerror == 'No such file or directory':
                    time.sleep(60)


killing = KillTranscribe()
killing.main()
